...
### 7. Streaming Chat with Typewriter Effect 🎬

```bash
# Set your OpenAI API key 
export OPENAI_API_KEY="your-api-key-here"

# Run the typewriter chat demo
cargo run --example typewriter_chat --features builtin-llm

# Or use the test script
./test_typewriter.sh
```

Interactive chatbot demonstrating real-time streaming responses with realistic typewriter effects. Features:
- 🔄 **Real-time streaming**: Characters appear as they're generated by the AI
- ⌨️ **Typewriter animation**: Natural typing delays for different characters (letters, spaces, punctuation)
- 📊 **Performance metrics**: Response time and character count tracking
- 🎨 **Rich formatting**: Emojis, colors, and conversation history
- 🚀 **Demo mode**: Works without API key for testing

The typewriter effect simulates human typing speed with:
- Letters: 30ms delay (realistic typing speed)
- Spaces/Tabs: 80ms delay (natural pause between words)  
- Punctuation: 200ms delay (longer pause for sentence boundaries)
- Newlines: No delay (immediate line breaks)
