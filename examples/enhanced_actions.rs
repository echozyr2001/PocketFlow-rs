use pocketflow_rs::{
    Action, ActionBuilder, ActionCondition, ComparisonOperator, InMemorySharedStore,
};
use serde_json::json;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "Simple actions: {}, {}, {}",
        simple_action, from_string, from_str
    );
    ...
    let action_with_metadata = Action::with_metadata(Action::simple("user_action"), metadata);
